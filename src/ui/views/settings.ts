...
export function dismissCfgTip(){ state.cfgTipDismissed = true; save(); const el = document.getElementById("cfgTip"); if (el) el.style.display = "none"; }
