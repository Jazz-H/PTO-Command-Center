...
export function normImportType(s){ const k = String(s||"").trim().toLowerCase(); const map = {pto:"PTO", vacation:"PTO", vac:"PTO", personal:"PTO", ooo:"PTO", "out of office":"PTO", sick:"Sick", "out sick":"Sick", oos:"Sick", "personal holiday":"Personal Holiday", holiday:"Personal Holiday", ph:"Personal Holiday", bereavement:"Bereavement", jury:"Jury Duty", "jury duty":"Jury Duty", unpaid:"Unpaid"}; return map[k] || (s ? String(s).trim() : "PTO"); }
